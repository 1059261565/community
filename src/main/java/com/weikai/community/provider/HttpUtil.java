...
public class HttpUtil {
     ...
     * @throws Exception
     */
    public static String post(String urlStr, AccessTokenDTO accessTokenDTO) throws Exception{
        HttpURLConnection conn = null;
        ...
        try{
            ...
            URL url = new URL(urlStr);
            //获取请求参数
            String param = JSON.toJSONString(accessTokenDTO);
            //获取URL连接
            conn = (HttpURLConnection) url.openConnection();
            //设置通用请求属性
    ...
    public static void main(String[] args){
        try {
            System.out.println( post("https://github.com/login/oauth/access_token", null) );
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
